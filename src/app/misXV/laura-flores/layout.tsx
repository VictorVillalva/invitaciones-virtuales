...
export default function LauraLayout({ children }: Readonly<{ children: React.ReactNode; }>) {
    return (
        <>
            <section className={`laura-flores-layout ${lobsterTwo.className} antialiased relative bg-[#FAECEB]`}>
