      ...
      <main className="pre-invitacion-pamela-castillo flex flex-col gap-[150px] px-4 py-[150px]">
        ...
        <section data-aos="fade-dowm" className="Espera-la-invitación">
          <div className="flex flex-col gap-3 text-center px-4 text-pamela-primary">
            <h2 className=" font-bold text-[40px] tracking-[-0.06em] leading-[40px]">
              Espera la invitación oficial
            </h2>
            <p className="tracking-[-0.02em]">
              Estamos trabajando en todos los detalles para que este evento sea
              especial, en los próximos días estarás recibiendo la información
              oficial para este gran evento
            </p>
          </div>
        </section>
        <section data-aos="fade-dowm" className="separador-invitation">
        ...
        <section data-aos="fade-dowm" className="misXV">
          <div className="flex flex-col justify-center items-center text-center gap-2">
            <span
              className={`${ephesis.className} text-[64px] leading-none text-[#C4870A]`}
            >
              Mis XV
            </span>
            <span
              className={`${ephesis.className} text-[32px] font-bold text-[#9C610C]`}
            >
