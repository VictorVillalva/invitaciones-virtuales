...
export default function PadrinosInvitation({nombre1, apellido1, nombre2, apellido2 , classNameNombres, classNameTitle }: Nombres) {
    return (
        <div className="padres text-center flex flex-col gap-6">
            <p className={`${classNameTitle} text-[32px]`}>Mis Padrinos</p>
